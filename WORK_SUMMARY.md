...
| 파일 | 쿼리 버전 |
|------|-----------|
| `index.html` | style.css?v=32, script.js?v=34 |
| `style.css` | v32 |
| `script.js` | v34 |
| `sw.js` | CACHE_NAME: `yc-prayer-v34` |
...
### v2.7.6 — Chrome Android 드래그/팝업 깜빡임 근본 수정 (최신)
...
- v2.7.6 GitHub push 완료 ✅
- **미확인**: Chrome Android PWA에서 v2.7.6 테스트 결과 아직 없음
- 테스트 방법: 크롬 PWA 실행 → 설정(⚙️) → 앱 새로고침 → v2.7.6 확인 → 드래그/팝업 테스트
- 다음 버전은 **v2.7.7**, SW는 **v35**, script.js?v=**35**, style.css?v=**33** 으로 올릴 것
