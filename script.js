...
// ── 시즌 유틸 ──
function getActiveSeason() { return localStorage.getItem('activeSeason') || 's2'; }
...
console.log('[ycpraying v3.2.21] season:', getActiveSeason(), 'membersRef:', membersRef.toString());
...
const SEASON_MUSIC = { s1: '0wcxl81QclQ', s2: 'V4NLpgUJHCU' };
